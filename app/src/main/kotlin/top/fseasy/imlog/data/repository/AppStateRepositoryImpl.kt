...
constructor(
  ...
  @ApiStatus.Internal
  override suspend fun setCurrentId(userId: UserId) =
  ...
  private fun getString(key: StateKey, default: String = ""): String =
      database.appStateQueries.getByKey(key.rawKey).executeAsOneOrNull()?.value_ ?: default

  private fun getBoolean(key: StateKey, default: Boolean = false): Boolean =
      getString(key).toBooleanStrictOrNull() ?: default

  private fun getInt(key: StateKey, default: Int = 0): Int = getString(key).toIntOrNull() ?: default
