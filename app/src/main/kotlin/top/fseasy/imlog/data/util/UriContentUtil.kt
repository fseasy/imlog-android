...
/** Run in IO thread. No exception thrown. */
    ...
    withContext(Dispatchers.IO) {
      try {
        context.contentResolver
            .openOutputStream(tgtFileUri, FileWriteMode.WRITE_TRUNCATE.value)
            ?.use { it.write(content) }
            ?: WriteDataResult.Error.Unexpected(
...
/** Copy file from src uri to tgt uri. Effective for SAF uri and MediaStore Uri. */
