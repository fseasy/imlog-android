...
/**
 * Represents a file path that the app can directly access via normal file APIs (e.g.
 * context.filesDir, cacheDir, etc.).
 *
 * Using String is sufficient at the domain level.
 */
@JvmInline @Serializable value class AppPath(val value: String)
...
/**
 * Used in condition that needs an output paths. Use this way to obey the clean architecture
 * requirements. Limit this class usage in Domain layer and StorageRepository.
 *
...
/**
 * In domain layer, it's used in user-given file condition, or file processing result. In data/UI
 * layer, should prefer use this type instead of @StoragePathModel.
 *
